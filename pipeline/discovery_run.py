...
def _ask_focus_simple():
    """Ask user for a one-sentence thesis (focus) or skip."""
    focus = _input("  Focus (Enter = skip): ").strip()
    return focus if focus else None


# _suggest_focus removed -- not needed in upgrade mode
